...
input_mesh_folder = r'/home/hao/ShapeOPT/TestDev2/Vn'
output_field_folder = r'/home/hao/ShapeOPT/TestDev2/Vn/Vn_field'

# found_original_mesh_file = False
input_files = []
output_files = []
for file in os.listdir(input_mesh_folder):
    if file.endswith(r'original.vtk'):
        mesh_file_original = os.path.join(input_mesh_folder, file)
        # found_original_mesh_file = True
    elif file.endswith(r'.vtk'):
        input_files.append(os.path.join(input_mesh_folder, file))
        output_files.append(
            os.path.join(output_field_folder,
